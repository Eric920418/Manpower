...
export default function WorkersCTA({ title, description, buttonText, buttonLink }: Props) {
  return (
    <section className="py-24 bg-gradient-to-br from-brand-secondary to-brand-primary">
