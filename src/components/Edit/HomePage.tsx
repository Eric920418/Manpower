  ...
  return (
    <div>
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                type="text"
                value={pageData.header.contactButton.link}
                onChange={(e) => updateContactButton("link", e.target.value)}
                className="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 border border-gray-300"
              />
            </div>
          </div>
      ...
      <div className="bg-gradient-to-r from-teal-50 to-cyan-50 p-6 rounded-lg mb-6 border-2 border-teal-200">
        <h2 className="text-2xl font-bold mb-4 text-teal-900">聯絡我們區塊設定</h2>

        <div className="space-y-6">
          {/* 標題與描述 */}
          <div className="bg-white p-4 rounded-lg">
            <h3 className="text-lg font-semibold mb-3">基本設定</h3>
            <div className="space-y-3">
              <div>
                <label className="block text-sm font-medium mb-1">徽章文字</label>
                <input
                  type="text"
                  value={pageData.contactSection.badge}
                  onChange={(e) =>
                    setPageData((prev) => ({
                      ...prev,
                      contactSection: { ...prev.contactSection, badge: e.target.value },
                    }))
                  }
                  className="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 border border-gray-300"
                />
          ...
          {/* 表單欄位設定 */}
          <div className="bg-white p-4 rounded-lg">
            <h3 className="text-lg font-semibold mb-3">表單欄位設定</h3>
            ...
            <div className="mb-4 p-3 bg-gray-50 rounded">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    type="text"
                    value={pageData.contactSection.formFields.name.label}
                    onChange={(e) =>
                      setPageData((prev) => ({
                        ...prev,
                        contactSection: {
                          ...
                          formFields: {
                            ...
                            name: { ...prev.contactSection.formFields.name, label: e.target.value },
                          },
                        },
                      }))
                    }
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={pageData.contactSection.formFields.name.placeholder}
                    onChange={(e) =>
                      setPageData((prev) => ({
                        ...prev,
                        contactSection: {
                          ...
                          formFields: {
                            ...prev.contactSection.formFields,
                            name: { ...prev.contactSection.formFields.name, placeholder: e.target.value },
                          },
                        },
                      }))
                    }
            ...
            <div className="mb-4 p-3 bg-gray-50 rounded">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    type="text"
                    value={pageData.contactSection.formFields.email.label}
                    onChange={(e) =>
                      setPageData((prev) => ({
                        ...prev,
                        contactSection: {
                          ...
                          formFields: {
                            ...prev.contactSection.formFields,
                            email: { ...prev.contactSection.formFields.email, label: e.target.value },
                          },
                        },
                      }))
                    }
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={pageData.contactSection.formFields.email.placeholder}
                    onChange={(e) =>
                      setPageData((prev) => ({
                        ...prev,
                        contactSection: {
                          ...
                          formFields: {
                            ...prev.contactSection.formFields,
                            email: { ...prev.contactSection.formFields.email, placeholder: e.target.value },
                          },
                        },
                      }))
                    }
            ...
            <div className="mb-4 p-3 bg-gray-50 rounded">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    type="text"
                    value={pageData.contactSection.formFields.phone.label}
                    onChange={(e) =>
                      setPageData((prev) => ({
                        ...prev,
                        contactSection: {
                          ...
                          formFields: {
                            ...prev.contactSection.formFields,
                            phone: { ...prev.contactSection.formFields.phone, label: e.target.value },
                          },
                        },
                      }))
                    }
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={pageData.contactSection.formFields.phone.placeholder}
                    onChange={(e) =>
                      setPageData((prev) => ({
                        ...prev,
                        contactSection: {
                          ...
                          formFields: {
                            ...prev.contactSection.formFields,
                            phone: { ...prev.contactSection.formFields.phone, placeholder: e.target.value },
                          },
                        },
                      }))
                    }
            ...
            <div className="mb-4 p-3 bg-gray-50 rounded">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    type="text"
                    value={pageData.contactSection.formFields.message.label}
                    onChange={(e) =>
                      setPageData((prev) => ({
                        ...prev,
                        contactSection: {
                          ...
                          formFields: {
                            ...prev.contactSection.formFields,
                            message: { ...prev.contactSection.formFields.message, label: e.target.value },
                          },
                        },
                      }))
                    }
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={pageData.contactSection.formFields.message.placeholder}
                    onChange={(e) =>
                      setPageData((prev) => ({
                        ...prev,
                        contactSection: {
                          ...
                          formFields: {
                            ...prev.contactSection.formFields,
                            message: { ...prev.contactSection.formFields.message, placeholder: e.target.value },
                          },
                        },
                      }))
                    }
            ...
            <div className="p-3 bg-gray-50 rounded">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={pageData.contactSection.submitButton.text}
                  onChange={(e) =>
                    setPageData((prev) => ({
                      ...prev,
                      contactSection: {
                        ...prev.contactSection,
                        submitButton: { ...prev.contactSection.submitButton, text: e.target.value },
                      },
                    }))
                  }
                  className="block w-full rounded-md bg-white px-3 py-2 text-base text-gray-900 border border-gray-300"
          ...
          <div className="bg-white p-4 rounded-lg">
            <div className="flex justify-between items-center mb-3">
              <h3 className="text-lg font-semibold">聯絡資訊卡片</h3>
              <button
                onClick={() => {
                  const newContactInfo = [
                    ...pageData.contactSection.contactInfo,
                    { icon: "mail", title: "", content: "", description: "", link: "#" },
                  ];
                  setPageData((prev) => ({
                    ...prev,
                    contactSection: { ...prev.contactSection, contactInfo: newContactInfo },
                  }));
                }}
            ...
            {pageData.contactSection.contactInfo.map((info, index) => (
              <div key={index} className="mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="font-semibold">卡片 #{index + 1}</h4>
                  <button
                    onClick={() => {
                      const newContactInfo = pageData.contactSection.contactInfo.filter((_, i) => i !== index);
                      setPageData((prev) => ({
                        ...prev,
                        contactSection: { ...prev.contactSection, contactInfo: newContactInfo },
                      }));
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      value={info.icon}
                      onChange={(e) => {
                        const newContactInfo = [...pageData.contactSection.contactInfo];
