...
import ManpowerRequestForm from "@/components/Resume/ManpowerRequestForm";
...
export default async function ManpowerRequestPage() {
  try {
    const { page: pageData, navigations } = await getPageData();
    ...
    return (
      <main className="relative flex min-h-screen w-full flex-col bg-bg-primary">
        {/* 固定背景 Logo */}
        <div
