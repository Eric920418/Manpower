...
--
-- Name: FormSubmission_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: FormSubmission_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: FormTemplate_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: FormTemplate_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: Signature_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: FormSubmission id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: FormTemplate id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: Signature id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: Attachment_contractId_createdAt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "Attachment_contractId_createdAt_idx" ON public."Attachment" USING btree ("contractId", "createdAt" DESC);


--
-- Name: Attachment_contractId_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "Attachment_contractId_idx" ON public."Attachment" USING btree ("contractId");


--
-- Name: Attachment_formId_createdAt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "Attachment_formId_createdAt_idx" ON public."Attachment" USING btree ("formId", "createdAt" DESC);


--
-- Name: Attachment_formId_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "Attachment_formId_idx" ON public."Attachment" USING btree ("formId");
...
--
-- Name: Contract_contractNo_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Contract_contractNo_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Contract_createdBy_createdAt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "Contract_createdBy_createdAt_idx" ON public."Contract" USING btree ("createdBy", "createdAt" DESC);
...
--
-- Name: Contract_status_validUntil_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "Contract_status_validUntil_idx" ON public."Contract" USING btree (status, "validUntil");


--
-- Name: Contract_templateId_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "Contract_templateId_idx" ON public."Contract" USING btree ("templateId");


--
-- Name: Contract_validFrom_validUntil_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "Contract_validFrom_validUntil_idx" ON public."Contract" USING btree ("validFrom", "validUntil");


--
-- Name: FormSubmission_createdById_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "FormSubmission_createdById_idx" ON public."FormSubmission" USING btree ("createdById");


--
-- Name: FormSubmission_formType_status_createdAt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "FormSubmission_formType_status_createdAt_idx" ON public."FormSubmission" USING btree ("formType", status, "createdAt" DESC);


--
-- Name: FormSubmission_processedBy_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "FormSubmission_processedBy_idx" ON public."FormSubmission" USING btree ("processedBy");


--
-- Name: FormSubmission_status_processedAt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "FormSubmission_status_processedAt_idx" ON public."FormSubmission" USING btree (status, "processedAt" DESC);


--
-- Name: FormSubmission_submitterEmail_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "FormSubmission_submitterEmail_idx" ON public."FormSubmission" USING btree ("submitterEmail" varchar_pattern_ops);


--
-- Name: FormSubmission_templateId_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: FormSubmission_templateId_status_createdAt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "FormSubmission_templateId_status_createdAt_idx" ON public."FormSubmission" USING btree ("templateId", status, "createdAt" DESC);
...
--
-- Name: Signature_contractId_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "Signature_contractId_idx" ON public."Signature" USING btree ("contractId");


--
-- Name: Signature_contractId_userId_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "Signature_contractId_userId_key" ON public."Signature" USING btree ("contractId", "userId");
...
--
-- Name: ip_blocklist_blockedAt_expiresAt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "ip_blocklist_blockedAt_expiresAt_idx" ON public.ip_blocklist USING btree ("blockedAt", "expiresAt");


--
-- Name: ip_blocklist_ipAddress_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: Attachment Attachment_contractId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Attachment"
    ADD CONSTRAINT "Attachment_contractId_fkey" FOREIGN KEY ("contractId") REFERENCES public."Contract"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: Attachment Attachment_formId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Attachment"
    ADD CONSTRAINT "Attachment_formId_fkey" FOREIGN KEY ("formId") REFERENCES public."FormSubmission"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: Contract Contract_createdBy_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Contract"
    ADD CONSTRAINT "Contract_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE ONLY public."Contract"
    ADD CONSTRAINT "Contract_templateId_fkey" FOREIGN KEY ("templateId") REFERENCES public."ContractTemplate"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: FormSubmission FormSubmission_createdById_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."FormSubmission"
    ADD CONSTRAINT "FormSubmission_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: FormSubmission FormSubmission_processedBy_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."FormSubmission"
    ADD CONSTRAINT "FormSubmission_processedBy_fkey" FOREIGN KEY ("processedBy") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: FormSubmission FormSubmission_templateId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."FormSubmission"
    ADD CONSTRAINT "FormSubmission_templateId_fkey" FOREIGN KEY ("templateId") REFERENCES public."FormTemplate"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: Signature Signature_contractId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Signature"
    ADD CONSTRAINT "Signature_contractId_fkey" FOREIGN KEY ("contractId") REFERENCES public."Contract"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: Signature Signature_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
